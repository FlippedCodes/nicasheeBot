...
module.exports.run = async (fs) => {
  ...
  if (DEBUG) console.log(`[${module.exports.help.name}] Loading ${funcLength} function${funcLength !== 1 ? 's' : ''}...`);
  ...
  console.log(`[${module.exports.help.name}] Loaded ${funcLength} function${funcLength !== 1 ? 's' : ''}!`);
};
